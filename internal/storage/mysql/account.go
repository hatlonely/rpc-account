...
func (m *MySQL) PutArticle(ctx context.Context, article *storage.Account) (string, error) {
	article.ID = hex.EncodeToString(uuid.NewV4().Bytes())
	return article.ID, m.db.Create(ctx, article).Unwrap().Error
}

func (m *MySQL) GetArticle(ctx context.Context, id string) (*storage.Account, error) {
...
func (m *MySQL) UpdateArticle(ctx context.Context, article *storage.Account) error {
